...
사이드바를 통해 접근 가능한 주요 계산기 및 페이지 목록입니다. 새로운 기능을 추가하거나 수정할 때 이 표를 참조하십시오.

| 한글 화면명 | HTML 파일명 | 주요 기능 설명 |
| :--- | :--- | :--- |
| **보상분배계산기** | `pages/bunbae.html` | 결정석 가격 및 경매장 수수료를 반영한 1/N 및 차등 분배 계산 |
| **주간보스 시급계산기** | `pages/weeklyBoss.html` | 보스별 클리어 타임 대비 수익을 시급으로 환산 및 다중 캐릭터 합산 |
| **메소마켓 효율** | `pages/mesoMarket.html` | 현금 직거래 vs 메소마켓(캐시/엠작) 구매 효율 비교 분석 |
| **아이템 현금가치** | `pages/mesoToWon.html` | 인게임 아이템의 메소 가격을 현재 시세 기준 현금 가치로 변환 |
| **주흔 효율** | `pages/juHeunVal.html` | 주문의 흔적 가치 산정 |
| **피시방 효율 계산** | `pages/pcRoom.html` | 피시방 비용 대비 솔 에르다 조각 등 보상의 가동비 효율 계산 |
| **메소가치 비교** | `pages/valueOf.html` | 과거 시점과 현재 시점의 메소 구매력 및 아이템 상대 가치 비교 |
